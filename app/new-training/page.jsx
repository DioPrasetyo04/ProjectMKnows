...
export default function NewTraining() {
  const trainings = [
    ...
    { 
      title: "AI Sales Tools: Meningkatkan Penjualan dan Profit Berlipat Ganda Menggunakan IT Tools", 
    ...
    { 
      title: "Pembuatan AI Credit Scoring untuk Kredit Produktif, Usaha Kecil, Mikro dan Ultra Mikro", 
      dates: "28–29 Jan | 19–20 Feb | 12–13 Mar | 21–22 Mei | 25–26 Jul | 26–27 Sep | 25–26 Nov",
      pdf: "training.pdf", 
    }, 
    { 
      title: "Transformasi Kinerja Tim Penagihan Menggunakan Tools Artificial Intelligence 2.0", 
      dates: "28–29 Jan | 19–20 Feb | 23–24 Apr | 19–20 Jun | 22–23 Agu | 24–25 Okt | 12–13 Des", 
      pdf: "training.pdf",
    }, 
    { 
      title: "Build Your Own Report-Summarizing Chatbot with GEN AI", 
      dates: "29–30 Jan | 23–24 Feb | 28–29 Mei | 1–2 Jul | 30–31 Okt | 15–16 Des", 
      pdf: "training.pdf",
    }, 
    { 
      title: "Create a 24/7 Customer Service Chatbot with GEN AI (LLM OpenAI) for Any Industry", 
      dates: "28–29 Jan | 19–20 Feb | 23–24 Apr | 19–20 Jun | 22–23 Agu | 24–25 Okt | 12–13 Des", 
      pdf: "training.pdf",
    }, 
    { 
      title: "Prompt Engineering Mastery: A Game-Changer for Sales, Entrepreneurs, and Professionals", 
    ...
    { 
      title: "Teknologi Virtual Reality Untuk Transformasi Bisnis, Pengembangan Karyawan dan Peningkatan Profit", 
      dates: "15–16 Jan | 5–6 Feb | 11–12 Apr | 4–5 Jul | 15-16 Sep | 10-11 Nov", 
      pdf: "training.pdf",
    },  
    { 
      title: "Transformasi dan Digitalisasi Bisnis Memanfaatkan AI, IoT & Blockchain Bagi Pimpinan Perusahaan", 
      dates: "15–16 Jan | 5–6 Feb | 11–12 Apr | 4–5 Jul | 15–16 Sep | 10–11 Nov", 
      pdf: "training.pdf",
    }, 
    { 
      title: "Cyber Security for Digital Banking & Fintech in Indonesia", 
      dates: "28–29 Jan | 19–20 Feb | 12–13 Mar | 21–22 Mei | 25–26 Jul | 26–27 Sep | 26–27 Nov", 
      pdf: "training.pdf",
    },  
    {
      title: "Cyber Security: Policy Updates, Regulation Compliance, Future Requirement & Internal‑Team Preparation",
      dates: "28–29 Jan | 19–20 Feb | 23–24 Apr | 19–20 Jun | 22–23 Agt | 24–25 Okt | 12–13 Des",
      pdf: "training.pdf",
    },
    { 
    ...
    { 
      ...
      dates: "22–23 Jan | 16–17 Feb | 14–15 Mei | 18–19 Jul | 21–22 Sep | 17–18 Nov",
      pdf: "training.pdf", 
    }, 
    { 
      title: "Mastering UI/UX Design: Figma Pro Workflows & Advanced Techniques", 
      dates: "28–29 Jan | 19–20 Feb | 12–13 Mar | 21–22 Mei | 25–26 Jul | 26–27 Sep | 26–27 Nov", 
      pdf: "training.pdf",
    }, 
    { 
      title: "Front-End Framework Front End Modern: React, Next.js, & Tailwind CSS", 
      dates: "29–30 Jan | 23–24 Feb | 28–29 Mei | 1–2 Jul | 30–31 Okt | 15–16 Des",
      pdf: "training.pdf", 
    }, 
    { 
      title: "Komunikasi dan Negosiasi Tingkat Lanjut bagi Sales, Marketing & Purchasing", 
      dates: "21–22 Jan | 12–13 Feb | 5–6 Mar | 12–13 Jun | 14-15 Agt | 13–14 Okt", 
      pdf: "training.pdf",
    }, 
    { 
      title: "Digital Marketing & E-Commerce & Social Media Selling", 
      dates: "21–22 Jan | 12–13 Feb | 5–6 Mar | 12–13 Jul | 14-15 Agt | 13–14 Okt", 
      pdf: "training.pdf",
    },
  ];
    ...
    <div className="font-montserrat bg-[#DEE5E7] min-h-screen text-[#02353C] relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 md:px-20 pt-40 py-16">
        <p className="text-[#6E7E80] text-xl md:text-2xl font-montserrat font-semibold mb-2">
          Public Training{" "}
          <span className="text-[#02353C] font-montserrat">New Training 2026</span>
        </p>

        <h1 className="text-[48px] font-montserrat font-bold mb-6">New Training 2026</h1>
