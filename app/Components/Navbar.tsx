        ...
        <div className="relative">
          ...
          <AnimatePresence>
            {openService && (
              ...
              >
                <h3 className="text-2xl font-montserrat font-semibold mb-4">Our Services</h3>
                    ...
                    <AnimatePresence>
                      {activeSubmenu === menu && (
                        ...
                        >
                          {menu === "Training" && (
                            <>
                              <p onClick={() => navigateTo("/training/public")} className="cursor-pointer hover:text-[#B9F443]">Public In House Training</p>
                              <p onClick={() => navigateTo("/training/bootcamp")} className="cursor-pointer hover:text-[#B9F443]">Bootcamp Program</p>
                              <p onClick={() => navigateTo("/training/outbound")} className="cursor-pointer hover:text-[#B9F443]">Outbound & Event</p>
                              <p onClick={() => navigateTo("/training/lms")} className="cursor-pointer hover:text-[#B9F443]">Learning Management System</p>
                              <p onClick={() => navigateTo("/training/custom-lms")} className="cursor-pointer hover:text-[#B9F443]">Pengembangan LMS Kustom</p>
                            </>
                          )}
                          {menu === "Consulting" && (
                            <>
                              <p onClick={() => navigateTo("/consulting/brand")} className="cursor-pointer hover:text-[#B9F443]">Brand Consulting</p>
                              <p onClick={() => navigateTo("/consulting/coaching")} className="cursor-pointer hover:text-[#B9F443]">Executive Coaching</p>
                              <p onClick={() => navigateTo("/consulting/development")} className="cursor-pointer hover:text-[#B9F443]">Hybrid Officer Development</p>
                              <p onClick={() => navigateTo("/consulting/assessment")} className="cursor-pointer hover:text-[#B9F443]">Assessment for Technical Competency</p>
                            </>
                          )}
                          {menu === "Digitalisasi" && (
                            <>
                              <p onClick={() => navigateTo("/digital/ai")} className="cursor-pointer hover:text-[#B9F443]">Solusi AI</p>
                              <p onClick={() => navigateTo("/digital/web")} className="cursor-pointer hover:text-[#B9F443]">Web Development</p>
                              <p onClick={() => navigateTo("/digital/mobile")} className="cursor-pointer hover:text-[#B9F443]">Apps Development</p>
                              <p onClick={() => navigateTo("/digital/game")} className="cursor-pointer hover:text-[#B9F443]">Game Development</p>
                              <p onClick={() => navigateTo("/digital/marketing")} className="cursor-pointer hover:text-[#B9F443]">Digital Marketing</p>
                              <p onClick={() => navigateTo("/digital/content")} className="cursor-pointer hover:text-[#B9F443]">Content Creator</p>
                              <p onClick={() => navigateTo("/digital/vr")} className="cursor-pointer hover:text-[#B9F443]">Virtual Reality</p>
                            </>
                          )}
                        </motion.div>
                      )}
