      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
        ...
        <div className="order-1 md:order-1">
          ...
          <p className="text-[#989898] font-medium font-montserrat leading-relaxed ml-8">
            Jl. Raya Cirendeu No.61 Ciputat,<br />
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center justify-center md:justify-start">
              <img
                ...
                className="w-5 h-5 mr-2 cursor-pointer hover:scale-110 transition"
                onClick={() =>
                  (window.location.href = "mailto:learning@m-knowsconsulting.com")
                }
              />
              <span className="text-[#989898] font-medium font-montserrat">
          ...
          <div className="mt-6">
            ...
            <div className="flex justify-center md:justify-start space-x-0 ml-7">
              ...
              <a
                ...
                className="transition transform hover:scale-110"
              >
                <img src="/images/icons/youtube.png" alt="YouTube" className="w-10 h-10" />
              </a>
              <a
                ...
                className="transition transform hover:scale-110"
              >
                <img src="/images/icons/instagram.png" alt="Instagram" className="w-10 h-10" />
              </a>
              <a
                ...
                className="transition transform hover:scale-110"
              >
                <img src="/images/icons/tiktok.png" alt="TikTok" className="w-10 h-10" />
              </a>
              <a
                ...
                className="transition transform hover:scale-110"
              >
                <img src="/images/icons/facebook.png" alt="Facebook" className="w-10 h-10" />
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="text-[#989898] font-montserrat font-medium leading-relaxed ">
            ...
            <div className="flex items-center justify-center md:justify-start mt-1">
              <img
                ...
                className="w-5 h-5 mr-2 cursor-pointer hover:scale-110 transition"
                onClick={() =>
                  (window.location.href = "mailto:surabaya@m-knowsconsulting.com")
                }
              />
