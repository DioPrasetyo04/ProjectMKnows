...
const VIDEOS: VideoItem[] = [
  {
    title: "LMS Overview",
    src: "/utility/videos/video-lms.mp4",
    poster: "/images/lms/gambar-video-lms.jpg",
  },
  {
    title: "Onboarding Flow",
    src: "/utility/videos/onboarding.mp4",
    poster: "/images/lms/video-poster-2.jpg",
  },
  {
    title: "Demo Modul Interaktif",
    src: "/utility/videos/demo-1.mp4",
    poster: "/images/lms/video-poster-3.jpg",
  },
];
    ...
    <div className="fixed inset-0 z-[80] bg-black/70 backdrop-blur-sm grid place-items-center p-4">
      ...
      >
        ...
        <p className="mt-3 text-center text-white/75 text-sm">
          Tekan <kbd>Esc</kbd> untuk menutup, <kbd>←</kbd>/<kbd>→</kbd> untuk
          pindah video.
        </p>
      </div>
    </div>
              ...
              <div className="grid md:grid-cols-2 items-stretch gap-6 md:gap-8">
                ...
                <div className="h-full">
                  ...
                  <div className="mt-4 space-y-4 text-slate-700 text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] leading-[1.65] text-justify">
                    <p>
                      Kami menghadirkan{" "}
                      <strong>Learning Management System (LMS)</strong> yang
                      dirancang untuk memberikan fleksibilitas dan efisiensi
                      dalam kegiatan belajar, baik untuk pendidikan formal
                      maupun pelatihan profesional. LMS kami mendukung
                      pengelolaan materi pembelajaran dalam berbagai format,
                      seperti teks dan video, sehingga Anda dapat menyesuaikan
                      konten sesuai kebutuhan.
                    </p>
                    <p>
                      Selain itu, LMS ini memungkinkan pelaksanaan pembelajaran
                      secara
                      <em> sinkronus (real-time)</em> maupun{" "}
                      <em>asinkronus (belajar mandiri)</em>. Dengan desain yang
                      kompatibel untuk perangkat seluler, pengguna dapat
                      mengakses sistem ini kapan saja dan di mana saja,
                      memastikan pengalaman belajar yang seamless dan mudah
                      diintegrasikan dalam aktivitas sehari-hari. Kami juga
                      menyediakan layanan personalisasi desain yang memungkinkan
                      tampilan LMS disesuaikan dengan identitas perusahaan Anda.
                    </p>
                    <p>
                      Untuk memberikan kemudahan lebih lanjut, LMS ini
                      dikembangkan berbasis website, sehingga menjadi solusi
                      praktis dan efektif bagi implementasi <em>e-learning</em>{" "}
                      di lingkungan perusahaan Anda. Bersama kami, wujudkan
                      pembelajaran yang lebih efektif dan terstruktur untuk
                      mendukung pertumbuhan dan kesuksesan organisasi Anda.
                      Hubungi kami sekarang untuk diskusi lebih lanjut atau
                      mencoba demo gratis.
                    </p>
                  </div>
                </div>
                ...
                <div className="h-full space-y-6 text-slate-700 text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] leading-[1.65]">
                  <div>
                    ...
                    <p className="mt-2 text-justify">
                      Modul pembelajaran yang kami kembangkan mengacu pada
                      konsep <em>Activity Based Learning</em>
                      dengan memperhatikan level interaktif dari setiap
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-justify">
                      Grafis digunakan untuk menarik lebih banyak perhatian
                      peserta dalam pembelajaran. Kami dapat memberi Anda grafis
                      dalam bentuk 2D, 3D, <em>still</em> atau bergerak
                      tergantung pada kebutuhan instruksional Anda.
                    </p>
                  </div>
                  ...
                  <div className="grid gap-5">
                    <div>
                      ...
                      <p className="mt-2 text-justify">
                        Modul E-Learning Interaktif dengan metode{" "}
                        <em>Show &amp; Tell</em> untuk menyampaikan informasi
                        seperti pengetahuan produk, kebijakan, aturan, prosedur,
                        fakta, dll.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-justify">
                        ...
                        <em>Explanatory</em> untuk menyampaikan konsep dan
                        pengetahuan yang lebih dalam dengan dukungan ilustrasi
                        grafis.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-justify">
                        Modul E-Learning Interaktif dengan strategi penyampaian{" "}
                        <strong>Pengalaman</strong> untuk mencapai pemahaman
                        maksimal atas suatu pengetahuan melalui simulasi
              ...
              <div className="mt-8 grid md:grid-cols-2 items-stretch gap-6 md:gap-8">
                ...
                <div className="h-full space-y-6 text-slate-700 text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] leading-[1.65]">
                  <p className="text-justify">
                    Video pembelajaran merupakan alternatif lain untuk
                    mengefektifkan kegiatan pembelajaran. Jenis video yang kami
                    sediakan adalah <strong>video live action</strong> atau{" "}
                    <strong>video animasi</strong> tergantung kebutuhan
                    instruksional Anda.
                  </p>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-justify">
                      Video penjelasan animasi untuk menyampaikan informasi
                      seperti tutorial program atau platform dan informasi
                      lainnya dengan bantuan host karakter animasi serta
                      ilustrasi animasi.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-justify">
                      Video animasi 3D untuk menyampaikan informasi seperti
                      tutorial program atau platform dan informasi lainnya
                      dengan bantuan host karakter 3D dan animasi 3D.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-justify">
                      Video aksi langsung profesional untuk tutorial atau konsep
                      video wawancara dengan sinematografi menengah dan animasi
                      grafis gerak.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-justify">
                      Video penjelasan dengan menggunakan grafis gerak sederhana
                      untuk menyampaikan informasi seperti pengetahuan produk,
                      kebijakan, aturan, prosedur, fakta, dan lainnya.
                    </p>
                  </div>
                </div>
