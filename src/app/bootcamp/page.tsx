...
const programs: Program[] = [
  ...
  },
  {
    ...
    details: [
      "Workflow Blender modern",
      "Asset creation untuk portfolio",
      "Rendering & export",
    ],
  },
  {
    ...
    details: [
      "Lighting & exposure triangle",
      "Genre practice session",
      "Editing dasar",
    ],
  },
  {
  ...
  },
  {
    ...
    details: [
      "Next.js & SSR/ISR basic",
      "Atomic design & Tailwind",
      "React Query & pattern",
    ],
  },
  {
