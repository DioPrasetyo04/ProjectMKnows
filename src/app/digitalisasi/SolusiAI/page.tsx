      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="text-gray-600 space-y-4 text-base md:text-xl leading-relaxed">
            ...
            <p>
              AI Solution yang tepat juga dapat memberikan keuntungan yang
              signifikan bagi bisnis seperti penghematan biaya, peningkatan
              pendapatan, dan keunggulan kompetitif.
            </p>
            <p>
              Kami adalah tim ahli AI berpengalaman yang dapat membantu anda
              untuk memilih AI Solution yang tepat untuk kebutuhan bisnis anda.
              Kami menawarkan berbagai AI Solution seperti:
            </p>
          </div>
          ...
          <ul className="space-y-3 list-disc list-outside text-gray-700 pl-5 text-xl">
