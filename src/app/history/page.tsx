          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              <p className="text-gray-700 leading-relaxed text-3xl text-justify">
                ...
                yang berlokasi Jl. Raya Darmo Permai III sampai dengan sekarang.
                Tahun 2020 M-Knows membuka kantor untuk produksi solusi digital
                di jalan raya Cirendeu no 61 Tangerang Selatan.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              <p className="text-gray-700 leading-relaxed text-3xl text-justify">
                ...
                solusi Consulting Services, Public Training, In-house Training,
                dan Outbound & Team Building, sebelum mulai memberikan layanan
                solusi digital. Dalam kaitannya dengan Education & Learning
                Services sering kali menjadi merupakan bagian tak terpisahkan
                dari solusi konsultasi manajemen yang diberikan.
              </p>
            </div>
          </div>
        </div>
