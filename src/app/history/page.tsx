...
export default function HistoryPage() {
  return (
    <div className="relative flex flex-col pt-[110px] h-full">
      <div
        className="relative w-full h-full" // Padding atas/bawah
        style={{
          backgroundImage: "url('/images/history/history-background.png')",
      ...
      >
        ...
        <div className="relative container mx-auto px-4 pt-[40px]">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div>
                <p className="text-gray-700 leading-relaxed text-2xl">
                  ...
                  2008, M-Knows Consulting membuka kantor cabangnya di Surabaya
                  yang berlokasi Jl. Raya Darmo Permai III sampai dengan
                  sekarang. Tahun 2020 M-Knows membuka kantor untuk produksi
                  solusi digital di jalan raya Cirendeu no 6f Tangerang Selatan.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div>
                <p className="text-gray-700 leading-relaxed text-2xl">
                  ...
                  Training, dan Outbound & Team Building, sebelum mulai
                  memberikan layanan solusi digital. Dalam kaitannya dengan
                  Education & Learning Services sering kali menjadi merupakan
                  bagian tak terpisahkan dari solusi konsultasi manajemen yang
                  diberikan.
                </p>
              </div>
            </div>
