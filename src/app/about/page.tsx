        ...
        <section className="mb-16">
          <div className="bg-white p-8 rounded-lg shadow-md"> 
            <div className="flex flex-col md:flex-row-reverse gap-8 items-center">
              ...
              <div className="md:w-3/5"> 
                <h2 className="text-3xl font-bold mb-4">Jenis konsultasi yang sering diambil klien meliputi:</h2>
                <ul className="list-decimal list-outside ml-6 space-y-2 text-gray-700 text-2xl">
                  {konsultasiList.map((item, i) => <li key={i}>{item}</li>)}
                </ul>
                
                <h2 className="text-3xl font-bold mt-8 mb-4">Assessment for Technical Competency</h2>
                <ul className="list-decimal list-outside ml-6 space-y-2 text-gray-700 text-2xl">
