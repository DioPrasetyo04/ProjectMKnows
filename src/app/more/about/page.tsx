            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="md:w-3/5">
                ...
                <p className="text-gray-600 mb-8 text-2xl text-justify">
                  ...
                  konsultasi manajemen dan pembuatan solusi digital, seperti
                  aplikasi pendidikan (web dan app), solusi artificial
                  intelligence untuk industri keuangan dan pendidikan, serta
                  solusi virtual reality dan pembuatan game yang merupakan induk
                  perusahaan dari PT. Menara Pengetahuan Indonesia,  perusahaan
                ...
                <p className="text-gray-600 text-2xl text-justify">
                  ...
                  repeat order dan customer yang loyal Melalui cabang Jakarta &
                  Surabaya, M-Knows Consulting telah sukses melayani beragam
                  perusahaan dengan kualitas kerja yang memuaskan, sesuai
                  keahliannya dan pendekatan konsultasi yang menekankan pada
                  sifat Applicative, Contemporary, High Impact,  Fun &
                  Motivational.
                </p>
              </div>
            </div>
