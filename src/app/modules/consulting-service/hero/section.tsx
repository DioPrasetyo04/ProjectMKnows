const HeroSection = ({ handleClick }: { handleClick: any }) => {
  return (
      ...
      <div className="relative w-full max-w-[1440px] mx-auto">
        ...
        <div className="relative h-[220px] md:h-[280px] lg:h-[320px] overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 md:px-8">
            <h1 className="text-white text-3xl md:text-4xl lg:text-7xl font-extrabold tracking-wide text-center mb-3">
              CONSULTING SERVICE
            </h1>
            <p className="max-w-[900px] mx-auto text-center font-montserrat md:text-2xl text-white">
              Dari strategi ke eksekusi asesmen, pelatihan, coaching, dan
        ...
        <div className="relative -mt-6 md:-mt-10 bg-white px-4 md:px-10 lg:px-16 pt-8 pb-10 text-center">
          ...
          <p className="max-w-6xl mx-auto font-montserrat text-[27px] leading-relaxed text-black text-justify mb-6">
          ...
          <button
            className="mt-2 inline-flex items-center justify-center rounded-md bg-brand-green px-6 py-2 text-xs md:text-2xl font-semibold text-white hover:bg-brand-blue transition"
            onClick={handleClick}
          >
            Konsultasi Sekarang
          </button>
