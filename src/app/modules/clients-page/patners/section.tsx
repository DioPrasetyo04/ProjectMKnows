...
export function PartnerCategoryCard({ title, src }: PartnerCard) {
  return (
    <div className="rounded-xl border border-neutral-200 bg-white shadow-sm overflow-hidden">
      ...
      <div className="h-12 bg-gradient-to-l from-emerald-500 to-brand-blue px-4 text-white flex items-center font-montserrat text-lg md:text-xl lg:text-2xl font-semibold py-4">
        {title}
      </div>
...
export default function PartnersPage() {
  ...
  const renderCard = (item: PartnerCard) => (
