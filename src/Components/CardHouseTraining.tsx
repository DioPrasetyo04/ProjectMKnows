...
const CardHouseTraining = ({
  ...
  return (
    <div className="card w-[400px] h-[390px] rounded-[10px] bg-[#ffff] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] px-5 py-2 flex flex-col gap-y-[15px] mx-auto justify-center items-center">
