...
export default function StatisticCard({
  ...
  label: string;
  description: string;
  iconType: "experience" | "inhouse" | "public" | "happy";
}) {
  const iconMap = {
  ...
  return (
    ...
    >
      ...
      <p className="text-black text-[28px] font-bold font-montserrat">
        {label}
      </p>
      <p className="text-gray-700 text-[24px] font-montserrat font-medium">
        {description}
      </p>
    </motion.div>
  );
